...
import logoApoio from '../../assets/logo-apoio.svg';
          ...
          <motion.div className={styles.column} variants={itemVariants}>
            ...
            <div className={styles.contactInfo}>
              ...
              <div className={styles.contactItem}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                  <path
                    d="M22 16.92V19.92C22 20.52 21.39 21 20.83 21C9.28 21 0 11.72 0 0.17C0 -0.39 0.48 -1 1.08 -1H4.08C4.68 -1 5.08 -0.39 5.17 0.17C5.35 1.33 5.75 2.48 6.34 3.57C6.48 3.81 6.39 4.12 6.14 4.27L4.37 5.17C5.93 8.5 8.5 11.07 11.83 12.63L12.73 10.86C12.88 10.61 13.19 10.52 13.43 10.66C14.52 11.25 15.67 11.65 16.83 11.83C17.39 11.92 18 12.32 18 12.92V15.92C18 16.52 17.39 17 16.83 17C16.83 17 16.83 17 16.83 17"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                ...
                <button 
                  ...
                  onClick={() => handleContactClick('phone', '+5511999999999')}
                >
                  (11) 99999-9999
                </button>
              </div>
